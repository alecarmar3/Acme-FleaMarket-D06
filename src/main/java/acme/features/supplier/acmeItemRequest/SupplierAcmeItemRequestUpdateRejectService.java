...
@Service
public class SupplierAcmeItemRequestUpdateRejectService implements AbstractUpdateService<Supplier, AcmeItemRequest> {
	...
	public void update(final Request<AcmeItemRequest> request, final AcmeItemRequest entity) {
		...
		entity.setStatus(AcmeItemRequestStatus.REJECTED);
